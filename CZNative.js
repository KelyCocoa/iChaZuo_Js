...
var setNavigationBarTitle_completionHandler;
var setNavigationBarTitle = function(param) {
	setNavigationBarTitle_completionHandler = param["completionHandler"];
	param["completionHandler"] = 'setNavigationBarTitle_completionHandler';
	var message = {
...
var chaZuoApp_invoked = function(method_name, param) {
	chaZuoApp_invoked_completionHandler = param['completionHandler'];
...
var invokeNative = function(message) {
	...
	if(isIos) {
		...
		window.android.dispose(message)
	}
}